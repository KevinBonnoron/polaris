...
import { IntegrationBrowser } from '@/features/integrations/integration-browser';
    ...
    <>
      ...
      >
        ...
        {section === 'integrations' ? (
          <IntegrationBrowser project={project} className="-mr-4 min-h-0 flex-1 pr-2" scrollClassName="min-h-0 flex-1" />
        ) : (
