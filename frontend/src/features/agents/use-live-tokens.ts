...
// tokenTotal sums a usage breakdown; the backend no longer stores the total
// separately since the categories always sum to it.
export function tokenTotal(t: TokenParts | undefined | null): number {
  if (!t) {
    return 0;
  }
