...
import { Bell, Bot, Info, Keyboard, Palette, ScrollText, Settings } from 'lucide-react';
import { useTranslation } from 'react-i18next';
import { cn } from '@/lib/utils';

export type SettingsSection = 'general' | 'appearance' | 'agents' | 'notifications' | 'shortcuts' | 'logs' | 'about';
