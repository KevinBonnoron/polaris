...
import { CommitProject, GetProjectDiff, GetProjectFileStatuses, GetProjectGitState, ListProjectBranches, PushProject, StageProjectChanges, StageProjectFile, SwitchProjectBranch, SyncProject, UnstageProjectChanges, UnstageProjectFile } from '@/wailsjs/go/main/App';
