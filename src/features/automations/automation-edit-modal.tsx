...
import { automationsCollection } from '@/db';
          ...
          <ScrollArea className="-mr-3 max-h-[70vh] pr-3">
            {isCreating ? (
              <>
                ...
                {step === 3 && <ActionsStep form={form} agentKinds={agentKinds} statuses={statuses} hasJiraIntegration={hasJira} />}
              ...
              <div className="flex flex-col gap-4">
                ...
                <ActionsStep form={form} agentKinds={agentKinds} statuses={statuses} hasJiraIntegration={hasJira} />
              </div>
            )}
          </ScrollArea>
