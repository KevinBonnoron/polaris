...
import type { ActionKind, AutomationAction, JiraTransitionAction, NotificationAction, SendEmailAction, SpawnAgentAction } from '@/types';
...
const ACTION_KINDS: ActionKind[] = ['spawn_agent', 'jira_transition', 'notification', 'send_email'];

export function ActionsStep({ form, agentKinds, statuses, hasJiraIntegration, hasResendIntegration }: Props) {
...
function ActionCard({ index, action, agentKinds, statuses, hasJiraIntegration, hasResendIntegration, onChange, onRemove }: ActionCardProps) {
  const { t } = useTranslation();
