              ...
              <div className="py-1">
                {commandArgItems.map((arg, i) => (
                  ...
                  >
                    ...
                    {!arg.description && arg.label !== arg.value && (
                      <span className="ml-auto shrink-0 font-mono text-xs text-muted-foreground/60">
                        {arg.value.length > 8 ? arg.value.slice(0, 8) : arg.value}
                      </span>
                    )}
                  </button>
                ))}
