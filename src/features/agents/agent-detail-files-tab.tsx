...
import { CommitAgent, GetAgentDiff, GetAgentFileStatuses, GetAgentGitState, PushAgent, StageAgentChanges, StageAgentFile, SyncAgent, UnstageAgentChanges, UnstageAgentFile } from '@/wailsjs/go/main/App';
