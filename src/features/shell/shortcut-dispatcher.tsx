...
export function ShortcutDispatcher() {
  ...
  const { sessions, startSession, paneOpen, setPaneOpen } = useShellRun();
  ...
  }, [shortcuts, isMac, isRecording, toggleSidebar, kinds, projectId, navigate, palette, switcher, addProject, paneOpen, setPaneOpen, sessions, startSession]);
