...
type Launch = { kind: 'addProject' } | { kind: 'addIntegration' };
          ...
          <Command>
            ...
            <CommandList>
              ...
              <CommandGroup heading={t('commandPalette.groups.actions')}>
                ...
                <CommandItem onSelect={run(() => navigate({ to: '/settings', search: { section: 'general' } }))}>
                  <Settings />
              ...
              {nodejsConfig?.manifestPath && (nodejsActions.length > 0 || nodejsRunning) && (
                <>
                  <CommandSeparator />
              ...
              {pythonConfig?.manifestPath && (pythonActions.length > 0 || pythonRunning) && (
                <>
                  <CommandSeparator />
