...
export type AgentKind = 'claude-code' | 'copilot' | 'codex' | 'gemini' | 'mistral' | 'opencode' | 'other';
...
export type ActionKind = 'spawn_agent' | 'jira_transition' | 'notification' | 'send_email';
...
export type AutomationAction = SpawnAgentAction | JiraTransitionAction | NotificationAction | SendEmailAction;
