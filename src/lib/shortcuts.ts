...
export type ShortcutId = 'openPalette' | 'switchProject' | 'addProject' | 'newAgent' | 'toggleSidebar' | 'closeModal';
...
export const SHORTCUT_IDS: ShortcutId[] = ['openPalette', 'switchProject', 'addProject', 'newAgent', 'toggleSidebar', 'closeModal'];
