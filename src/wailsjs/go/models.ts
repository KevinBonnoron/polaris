...
export namespace dokploy {
	...
	export class Deployment {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.composeId = source["composeId"];
...
export namespace main {
	...
	export class DokployDashboard {
	    services: dokploy.Service[];
	    deployments: dokploy.Deployment[];
	
	    static createFrom(source: any = {}) {
	        return new DokployDashboard(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.services = this.convertValues(source["services"], dokploy.Service);
	        this.deployments = this.convertValues(source["deployments"], dokploy.Deployment);
	    }
...
export namespace polaris {
	...
	export class AppearanceSettings {
	    ...
	    cardAnimationStyle: string;
	    customThemes: CustomTheme[];
	    statusBarBlocks: string[];
	    gitChangesViewMode: string;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.thinkingStyleAccent = source["thinkingStyleAccent"];
	        this.cardAnimationStyle = source["cardAnimationStyle"];
	        this.customThemes = this.convertValues(source["customThemes"], CustomTheme);
	        this.statusBarBlocks = source["statusBarBlocks"];
	        this.gitChangesViewMode = source["gitChangesViewMode"];
	    }
	...
	export class AutomationAction {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.emailSubject = source["emailSubject"];
	...
	export class ClaudeSession {
	    ...
	    static createFrom(source: any = {}) {
	        return new ClaudeSession(source);
	    }
	...
	export class ClaudeUsage {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.weeklyByModel = this.convertValues(source["weeklyByModel"], ModelUsage, true);
	...
	export class CursorUsage {
	    ...
	    static createFrom(source: any = {}) {
	        return new CursorUsage(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.numRequests = source["numRequests"];
	        this.numRequestsTotal = source["numRequestsTotal"];
	        this.numTokens = source["numTokens"];
	        this.numCents = source["numCents"];
	        this.startOfMonth = source["startOfMonth"];
	        this.membershipType = source["membershipType"];
	        this.lastUpdated = source["lastUpdated"];
	        this.error = source["error"];
	    }
	}
	...
	export class GeneralSettings {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.ideId = source["ideId"];
	        this.ideCmd = source["ideCmd"];
	...
	export class ProviderHealth {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.discoveredModels = source["discoveredModels"];
	        this.unknownModels = source["unknownModels"];
	        this.toolModels = source["toolModels"];
	        this.toolModelsKnown = source["toolModelsKnown"];
	    }
	}
	...
	export class ShortcutsSettings {
	    ...
	    toggleTerminal: ShortcutBinding;
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.toggleTerminal = this.convertValues(source["toggleTerminal"], ShortcutBinding);
