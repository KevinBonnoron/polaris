...
export function OllamaIcon(props: React.SVGProps<SVGSVGElement>) {
...
export function HuggingFaceIcon(props: React.SVGProps<SVGSVGElement>) {
...
export function PerplexityIcon(props: React.SVGProps<SVGSVGElement>) {
